...
<body>
    ...
    <br>
    <br>
    <jsp:include page="v_hot.jsp"></jsp:include>
    <jsp:include page="totop.jsp"></jsp:include>
    <jsp:include page="h.jsp"></jsp:include>
    <div style="height:700px;width:800px"><div id="main" style="height:400px;width:600px;"></div></div>
    <div style="height:700px;width:800px"><div id="main1" style="height:400px;width:600px;"></div></div>
       ...
       },
       {
        ...
        require(
            ...
            function (ec) {
             ...
             //   ec.init(document.getElementById("main1"), 'macarons').setOption(option);
                // 自定义扩展图表类型：mapType = HK
                require('echarts/util/mapData/params').params.beijing = {
                    getGeoJson: function (callback) {
                        $.getJSON('bei_jing_geo.txt', function (data) {
