...
<html>
  <head>
    <title>My JSP 'v_hot.jsp' starting page</title>
  ...
  <body>
     <div id="navigation-block" >
		<ul id="sliding-navigation" style="z-index:999" onselectstart="return false;" >
			<li class="sliding-element" onclick="shrinkexpend()">
				<h3 id="volum" onmouseover="tip()" onmouseout="tipout()">热点地区</h3>
			</li>
